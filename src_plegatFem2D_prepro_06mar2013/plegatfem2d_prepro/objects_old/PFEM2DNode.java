...
public class PFEM2DNode implements IPFEM2DDrawableObject {
    ...
    private ArrayList<IPFEM2DElement> connectedElements = new ArrayList<IPFEM2DElement>();
    ...
    public PFEM2DPoint getInterpolatedPoint(PFEM2DNode nd2, double coef) {

        double xInt = this.x + (nd2.x - this.x) * coef;
        double yInt = this.y + (nd2.y - this.y) * coef;

        return new PFEM2DPoint(0, xInt, yInt);
    ...
    public PFEM2DNode getRotated(PFEM2DObjectManager pom, PFEM2DPoint centre, double angle) {
        ...
        /*
         System.out.println("angle base:  "+angleBase);
         System.out.println("angle:       "+angle);
         System.out.println("angle total: "+(angleBase+angle/180.*Math.PI));
         */
    ...
    public ArrayList<IPFEM2DElement> getConnectedElements() {
